...
export default function LogIn () {
    ...
    return (
        ...
        <div className="relative mt-24 px-12 text-center pb-24">
            ...
            <h1 className="text-memo-color font-black text-4xl mt-12 mb-6">Log In</h1>
            ...
            <div className="mt-20 flex flex-col gap-4">
                ...
                <button onClick={ logInAuth } className="button-inset gap-4 bg-gradient-to-r from-memo-light-blue to-memo-blue text-lg p-3 rounded-full">Log In</button>
            </div>

            <div className="relative mt-16 flex flex-col gap-4">
                <Link href={"#"} className="italic text-memo-color">Forgot Password</Link>
                <p className="text-memo-46">Not a Member? <Link href={"/sign-up"} className="italic text-memo-color font-semibold">Register</Link></p>
            </div>
        </div>
        </>
    )
